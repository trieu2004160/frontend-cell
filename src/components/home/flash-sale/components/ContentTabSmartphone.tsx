...
const ContentTabSmartphone = () => {
  ...
  return (
    <div className="flex justify-center absolute w-[285%] left-[-45rem]">
      <div className="flex items-center gap-x-4 px-4 py-2 rounded">
        <h3 className="text-white text-[1.2rem] font-bold">Kết thúc sau:</h3>
...
export default ContentTabSmartphone;
